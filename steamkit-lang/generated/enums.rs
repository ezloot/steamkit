...
impl Default for EChatEntryType {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EPersonaState {
    fn default() -> Self {
        Self::OFFLINE
    }
}
...
impl Default for EFriendRelationship {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl EClanPermission {
    ...
    pub const MEMBER_ALLOWED: Self = Self::NonMember | Self::Member;
    pub const MODERATOR_ALLOWED: Self = Self::NonMember | Self::Member | Self::Moderator;
    pub const OFFICER_ALLOWED: Self = Self::NonMember | Self::Member | Self::Moderator | Self::Officer;
    pub const OWNER_ALLOWED: Self = Self::NonMember | Self::Member | Self::Moderator | Self::Officer | Self::Owner;
    pub const ANYBODY: Self = Self::NonMember | Self::Member | Self::Moderator | Self::Officer | Self::Owner;
}
...
impl EChatPermission {
    ...
    pub const OWNER_DEFAULT: Self = Self::ChangeAccess | Self::Ban | Self::SetMetadata | Self::Mute | Self::Kick | Self::Talk | Self::Invite | Self::Close;
...
impl Default for EAppUsageEvent {
    fn default() -> Self {
        Self::GAME_LAUNCH
    }
}
...
impl Default for EPaymentMethod {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl Default for EPurchaseResultDetail {
    fn default() -> Self {
        Self::NO_DETAIL
    }
}
...
impl Default for EIntroducerRouting {
    fn default() -> Self {
        Self::FILE_SHARE
    }
}
...
impl Default for EClanRelationship {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl Default for EAuthSessionResponse {
    fn default() -> Self {
        Self::OK
    }
}
...
impl Default for EChatRoomEnterResponse {
    fn default() -> Self {
        Self::SUCCESS
    }
}
...
impl Default for EChatRoomType {
    fn default() -> Self {
        Self::FRIEND
    }
}
...
impl Default for EChatInfoType {
    fn default() -> Self {
        Self::STATE_CHANGE
    }
}
...
impl Default for EChatActionResult {
    fn default() -> Self {
        Self::SUCCESS
    }
}
...
impl Default for EAppInfoSection {
    fn default() -> Self {
        Self::UNKNOWN
    }
}
...
impl Default for EContentDownloadSourceType {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EPackageStatus {
    fn default() -> Self {
        Self::AVAILABLE
    }
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct EActivationCodeClass(pub u32);
...
impl PartialEq<u32> for EActivationCodeClass {
    fn eq(&self, other: &u32) -> bool {
        self.0 == *other
    }
}

impl PartialEq<EActivationCodeClass> for u32 {
    fn eq(&self, other: &EActivationCodeClass) -> bool {
        *self == other.0
    }
}

impl Default for EActivationCodeClass {
    fn default() -> Self {
        Self::WON_CD_KEY
    }
}
...
impl PartialEq<u8> for ERegionCode {
    fn eq(&self, other: &u8) -> bool {
        self.0 == *other
    }
}

impl PartialEq<ERegionCode> for u8 {
    fn eq(&self, other: &ERegionCode) -> bool {
        *self == other.0
    }
}

impl Default for ERegionCode {
    fn default() -> Self {
        Self::US_EAST
    }
}
...
impl Default for ECurrencyCode {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EWorkshopEnumerationType {
    fn default() -> Self {
        Self::RANKED_BY_VOTE
    }
}
...
impl Default for EPublishedFileVisibility {
    fn default() -> Self {
        Self::PUBLIC
    }
}
...
impl Default for EWorkshopFileType {
    fn default() -> Self {
        Self::FIRST
    }
}
...
impl Default for EWorkshopFileAction {
    fn default() -> Self {
        Self::PLAYED
    }
}
...
impl Default for EEconTradeResponse {
    fn default() -> Self {
        Self::ACCEPTED
    }
}
...
impl EMarketingMessageFlags {
    ...
    pub const PLATFORM_RESTRICTIONS: Self = Self::PlatformWindows | Self::PlatformMac | Self::PlatformLinux;
}
...
impl Default for ENewsUpdateType {
    fn default() -> Self {
        Self::APP_NEWS
    }
}
...
impl Default for ESystemIMType {
    fn default() -> Self {
        Self::RAW_TEXT
    }
}
...
impl Default for EDRMBlobDownloadErrorDetail {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl Default for EClientStat {
    fn default() -> Self {
        Self::P2P_CONNECTIONS_UDP
    }
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl Default for EClientStatAggregateMethod {
    fn default() -> Self {
        Self::LATEST_ONLY
    }
}
...
impl Default for ELeaderboardDataRequest {
    fn default() -> Self {
        Self::GLOBAL
    }
}
...
impl Default for ELeaderboardSortMethod {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl Default for ELeaderboardDisplayType {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl Default for ELeaderboardUploadScoreMethod {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl EUCMFilePrivacyState {
    ...
    pub const ALL: Self = Self::Public | Self::FriendsOnly | Self::Private;
}
...
impl Default for EPublishedFileInappropriateProvider {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EPublishedFileInappropriateResult {
    fn default() -> Self {
        Self::NOT_SCANNED
    }
}
...
impl Default for EDisplayStatus {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EChatRoomGroupType {
    fn default() -> Self {
        Self::DEFAULT
    }
}
...
impl Default for EChatroomNotificationLevel {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EChatRoomMemberStateChange {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EChatRoomServerMsg {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for EChatRoomGroupRank {
    fn default() -> Self {
        Self::DEFAULT
    }
}
...
impl Default for EChatRoomGroupAction {
    fn default() -> Self {
        Self::DEFAULT
    }
}
...
impl Default for EChatRoomJoinState {
    fn default() -> Self {
        Self::DEFAULT
    }
}
...
impl Default for EVoiceCallState {
    fn default() -> Self {
        Self::NONE
    }
}
...
impl Default for ETradeOfferState {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for ETradeOfferConfirmationMethod {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for ELobbyFilterType {
    fn default() -> Self {
        Self::STRING
    }
}
...
impl Default for ELobbyComparison {
    fn default() -> Self {
        Self::EQUAL_TO_OR_LESS_THAN
    }
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl Default for ELobbyDistanceFilter {
    fn default() -> Self {
        Self::CLOSE
    }
}
...
impl Default for ESteamIPv6ConnectivityProtocol {
    fn default() -> Self {
        Self::INVALID
    }
}
...
impl Default for ESteamIPv6ConnectivityState {
    fn default() -> Self {
        Self::UNKNOWN
    }
}
...
impl Default for ELauncherType {
    fn default() -> Self {
        Self::DEFAULT
    }
}
